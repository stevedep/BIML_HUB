    ...
    public partial class Form1 : Form
    {
        ...
        private void brnContainersOrch_Click(object sender, EventArgs e)
        {
            ...
            foreach (SequenceContainer sc in Containers)
             {
                 Debug.WriteLine(sc.ExtractTables.Count.ToString());
            }
            MessageBox.Show("klaar");
        }
        ...
        private void btnGenerateOrch_Click_1(object sender, EventArgs e)
        {
            ...
            foreach (SequenceContainer sc in Containers)
            {
                sb_excecute_package.Remove(0,sb_excecute_package.Length);
                Debug.WriteLine(sc.ExtractTables.Count.ToString());
            ...
            foreach (SequenceContainer sc in Containers)
            {
                sb_excecute_archive.Remove(0, sb_excecute_archive.Length);
                Debug.WriteLine(sc.ExtractTables.Count.ToString());
